...
// -----------------------------------------------------------------
// Description:
//   3-stage floating-point subtractor for fp16 (1 sign + 5 expo + 10 mantissa)
//   Implements FpSub<5,10> algorithm from nvdla_float.h
...
module fp16_sub (
    ...
    assign lead_zeros =
        ...
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-22]) ? 4'd21 : 4'd22;
    ...
    wire [10:0] mant_top = s3_int_mant_norm[INTERNAL_MANT_WIDTH-1:MANT_WIDTH];
