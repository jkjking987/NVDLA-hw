...
// -----------------------------------------------------------------
// Description:
//   3-stage floating-point multiplier for fp17 (1 sign + 6 expo + 10 mantissa)
//   Implements FpMul<6,10> algorithm from nvdla_float.h
...
module fp17_mul (
    ...
    wire [EXPO_WIDTH:0] sum_expo;  // 7-bit to avoid overflow
