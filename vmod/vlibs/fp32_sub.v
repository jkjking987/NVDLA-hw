...
// -----------------------------------------------------------------
// Description:
//   3-stage floating-point subtractor for fp32 (1 sign + 8 expo + 23 mantissa)
//   Implements FpSub<8,23> algorithm from nvdla_float.h
...
module fp32_sub (
    ...
    assign lead_zeros =
        ...
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-48]) ? 6'd47 : 6'd48;
