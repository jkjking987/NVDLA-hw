...
// -----------------------------------------------------------------
// Description:
//   3-stage floating-point adder for fp32 (1 sign + 8 expo + 23 mantissa)
//   Implements FpAdd<8,23> algorithm from nvdla_float.h
...
module fp32_add (
    ...
    localparam K_MANT_MORE_WIDTH = MANT_WIDTH + 2;  // 25
    localparam INTERNAL_MANT_WIDTH = K_MANT_MORE_WIDTH + MANT_WIDTH + 1;  // 49
    ...
    assign lead_zeros =
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-1]) ? 6'd0 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-2]) ? 6'd1 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-3]) ? 6'd2 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-4]) ? 6'd3 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-5]) ? 6'd4 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-6]) ? 6'd5 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-7]) ? 6'd6 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-8]) ? 6'd7 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-9]) ? 6'd8 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-10]) ? 6'd9 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-11]) ? 6'd10 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-12]) ? 6'd11 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-13]) ? 6'd12 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-14]) ? 6'd13 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-15]) ? 6'd14 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-16]) ? 6'd15 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-17]) ? 6'd16 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-18]) ? 6'd17 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-19]) ? 6'd18 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-20]) ? 6'd19 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-21]) ? 6'd20 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-22]) ? 6'd21 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-23]) ? 6'd22 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-24]) ? 6'd23 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-25]) ? 6'd24 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-26]) ? 6'd25 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-27]) ? 6'd26 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-28]) ? 6'd27 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-29]) ? 6'd28 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-30]) ? 6'd29 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-31]) ? 6'd30 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-32]) ? 6'd31 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-33]) ? 6'd32 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-34]) ? 6'd33 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-35]) ? 6'd34 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-36]) ? 6'd35 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-37]) ? 6'd36 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-38]) ? 6'd37 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-39]) ? 6'd38 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-40]) ? 6'd39 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-41]) ? 6'd40 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-42]) ? 6'd41 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-43]) ? 6'd42 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-44]) ? 6'd43 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-45]) ? 6'd44 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-46]) ? 6'd45 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-47]) ? 6'd46 :
        (s2_int_mant_q[INTERNAL_MANT_WIDTH-48]) ? 6'd47 :
        6'd48;
